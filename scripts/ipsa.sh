...
mkdir ~/HBV_splicing_paper_2020/doc/hbv/rnaseq/ipsa_out ~/virus/doc/hbv/rnaseq/ipsa_out/hbv ~/virus/doc/hbv/rnaseq/ipsa_out/hg19
...
for i in A2 B2 C2 D3; do \
  sed "s/^HBV/${i}/" ~/HBV_splicing_paper_2020/doc/hbv/rnaseq/gffcompare/${i}.gtf > ${OUT}/hbv/${i}.gtf
  cp ~/HBV_splicing_paper_2020/ref/hbv/pgrna/${i}/${i}.pgrna.fa ${OUT}/hbv/
done
...
for i in A2 B2 C2 D3; do \
  samtools view -h ~/HBV_splicing_paper_2020/doc/hbv/rnaseq/star_hbv_rep1/${i}/${i}.bam | sed "s/SN:HBV/SN:${i}/;s/\tHBV/\t${i}/" \
  | samtools view -bS - > ${i}_rep1.bam
  samtools view -h ~/HBV_splicing_paper_2020/doc/hbv/rnaseq/star_hbv/${i}/${i}.bam | sed "s/SN:HBV/SN:${i}/;s/\tHBV/\t${i}/" \
...
# building indexs for ipsa
cd ${IPSA}
perl Perl/transcript_elements.pl - < ~/HBV_splicing_paper_2020/ref/hg19/gencode.v19.annotation.gtf > ~/virus/ref/hg19/gencode.v19.annotation.gfx
# chroms directory contains fasta files of indivdual human chromosome
cd ~/HBV_splicing_paper_2020/ref/hg19/
${IPSA}/maptools-3.2/bin/transf -dir chroms/ -idx hg19.idx -dbx hg19.dbx

# merging pUC57 re1 and re2
cd ${IPSA}/hg19/
samtools merge pUC57.bam \
~/HBV_splicing_paper_2020/doc/hbv/rnaseq/star_hbv_rep1/pUC57/Aligned.sortedByCoord.out.rmdup.uniq.bam \
~/HBV_splicing_paper_2020/doc/hbv/rnaseq/star_hbv/pUC57/Aligned.sortedByCoord.out.rmdup.uniq.bam
...
cd ${IPSA}
perl Perl/annotate.pl -deltaSS 10 \
-annot ~/HBV_splicing_paper_2020/ref/hg19/gencode.v19.annotation.gfx \
-dbx ~/HBV_splicing_paper_2020/ref/hg19/hg19.dbx \
-idx ~/HBV_splicing_paper_2020/ref/hg19/hg19.idx \
